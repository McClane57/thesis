...
we get $\mathbf{c^{\mathrm{up}}} = s^\star$ as previously. However without the sparsification of \salgo, the cost of an upward communication is $\mathbf{c^{\mathrm{down}}} = d$. This yields the following gain in communication complexity of our algorithm %\recoalgo over \dave 
